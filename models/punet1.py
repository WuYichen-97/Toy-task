...
class PUNet(nn.Module):
    def __init__(self, npoint=1024, up_ratio=2, use_normal=False, use_bn=False, use_res=False):
        ...
        in_ch = 0 if not use_normal else 2
        ...
        ## feature Expansion
        in_ch = len(self.npoints) * 64 + 2 # 4 layers + input xyz
        ...
        self.pcd_layer = nn.Sequential(
            ...
            pt_utils.SharedMLP([64, 2], activation=None, bn=False)) 
...
if __name__ == '__main__':
    model = PUNet(up_ratio=4, use_normal=False).cuda()
